// /api/admin/auth - login e troca de senha do painel do CODELOGIC PRO
//
...
const COLECAO = 'codelogic_admin_auth';
const USUARIOS_OK = ['admplus', 'admin'];
    ...
    try {
        ...
        if (acao === 'login') {
            ...
            return res.status(200).json({
                ...
                message: (usuarioOk && senhaOk) ? 'Acesso liberado.' : 'UsuÃ¡rio ou senha incorretos.'
            });
        }
